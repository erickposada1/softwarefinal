...
<html>
	...
	<head>
		...
		<title>Informacion institución</title>
	...
	<body>
    	...
    	<div class="contenedor-principal">        	
        	...
        	<div class="contenedor-info" id="info-empresa">
            	...
            	<h1>Informacion de la Institución</h1>
            	...
            	<ul class="info-empresa">
                	...
                	<li class="li li-1">
                        ...
                        <figure class="logoImagen">
							<img src="<?php echo $logo;?>" height="80px" alt="Logotipo" title="Logotipo">
                        </figure>
					</li>
                    ...
                    <li class="li"><strong class="strong">Correo electrionico:</strong><span class="span"><?php echo $correo;?></span></li>
